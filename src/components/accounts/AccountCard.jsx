...
const AccountCard = ({ account }) => {
  ...
  return (
    <Link
      ...
      className="group relative block rounded-3xl p-5 bg-white dark:bg-obsidian-900 border-2 border-slate-200 dark:border-white/15 hover:border-brand-500 dark:hover:border-brand-400 shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col justify-between"
    >
      <div>
